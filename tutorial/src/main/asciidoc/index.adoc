...
image::connectivityTest.png[width="900"]
...
image::install1.png[width="700"]

This will trigger the devkit maven build, and generate an http://help.eclipse.org/luna/index.jsp?topic=%2Forg.eclipse.pde.doc.user%2Fconcepts%2Fupdate_site.htm[update site] folder.

After the update site is generated a popup will automatically open showing the task that will be performed.
[[install-dialog]]
image::install12.png[width="700"]
