...
There is no need for users to add custom code on their mule apps in order to handle session expirations. DevKit provides a mechanism to do this in a clean way.

You just need to annotated your @Proceesor method with the @ReconnectOn exception,
